...
Date.monthAbbreviations = new Array('Ene','Feb','Mar','Abr','May','Jun','Jul','Ago','Set','Oct','Nov','Dic');
// Full day names. Change this for local month names
Date.dayNames = new Array('Domingo','Lunes','Martes','Miércoles','Jueves','Viernes','Sábado');
// Day abbreviations. Change this for local month names
Date.dayAbbreviations = new Array('Dom','Lun','Mar','Mié','Jue','Vie','Sáb');
