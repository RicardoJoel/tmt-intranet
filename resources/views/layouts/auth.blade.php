...
<body>
	<div class="body-login">
		<div class="login">
			<div class="box-login">
				<center>
				<a href="{{ url('/') }}"><img src="{{ asset('images/logo-tmt.png') }}" class="logo"></a>
				</center>
				<p>{{ __('Esto es una intranet. Para acceder a nuestra web institucional, presiona ') }}<a href="https://www.tmt.gob.pe/">{{ __('aquí') }}</a>.</p>
                <main>
		...
		<div class="fondo-login">
			<img src="{{ asset('images/trujillo.jpg') }}" class="img-responsive">
		</div>
    </div>
    <footer>
