...
<div class="caja-login">
    ...
    <form method="POST" action="{{ route('password.update') }}">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input type="email" name="email" id="login_email" class="form-control @error('email') is-invalid @enderror" value="{{ $email ?? old('email') }}" maxlength="50" required autocomplete="email" autofocus>
            </div>
        </div>
