				...
				<div id="div-gen">
					<div class="fila">
						...
						<div class="columna columna-3">
							...
							<input type="text" name="alias" id="alias" maxlength="100" value="{{ old('alias') }}" onkeypress="return checkText(event)" required>
						</div>
					</div>
					<div class="fila">
						<div class="columna columna-3">
						...
						<div class="columna columna-6">
							<p>Referencia*</p>
							<input type="text" name="ref" id="ref" maxlength="3" value="{{ old('ref') }}" onkeypress="return checkAlpha(event)" onkeyup="return mayusculas(this)" required>
						</div>
						<div class="columna columna-3">
							<p>Representante legal</p>
							<input type="text" name="representative" id="representative" maxlength="100" value="{{ old('representative') }}" onkeypress="return checkName(event)">
						</div>
					</div>
					<div class="fila">
						<div class="columna columna-2">
