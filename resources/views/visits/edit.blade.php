				...
				<div id="div-gen">
					...
					<div class="fila">
						...
						<div class="columna columna-5">
							...
							<input type="hidden" name="customer_ref" id="customer_ref" value="{{ old('customer_ref',$visit->customer->ref) }}">
							<div class="search_field">
								<input type="text" name="customer_ruc" id="customer_ruc" value="{{ old('customer_ruc',$visit->customer->ruc) }}" maxlength="11" onkeypress="return checkNumber(event)" placeholder="R. U. C.*" required>
								<a onclick="clearDataCust()"><i class="fa fa-close fa-icon"></i></a>
							</div>
						</div>
						<div class="columna columna-5d">
							<input type="text" name="customer_name" id="customer_name" value="{{ old('customer_name',$visit->customer->aliasCode) }}" placeholder=" -- Nombre comercial y código* -- " readonly>
						</div>
						<div class="columna columna-5">
					...
					<div class="fila">
						...
						<div class="columna columna-5">
							...
							<div class="search_field">
								<input type="text" name="user_document" id="user_document" value="{{ old('user_document',$visit->accountable->document) }}" maxlength="15" onkeypress="return checkAlNum(event)" placeholder="N° Documento*" required>
								<a onclick="clearDataUser()"><i class="fa fa-close fa-icon"></i></a>
							</div>
						</div>
						<div class="columna columna-5d">
							<input type="text" name="user_wholename" id="user_wholename" value="{{ old('user_wholename',$visit->accountable->fullnameCode) }}" placeholder=" -- Nombre completo y código* -- " readonly>
						</div>
						<div class="columna columna-5">
        ...
        <div class="columna columna-1">
			<div class="form-section">
				...
				<div id="div-cmp">
					<div class="fila">
						<div class="columna columna-5">
							<label><input type="checkbox" name="is_done" id="is_done" value="1" {{ old('is_done',$visit->is_done) ? 'checked="checked"' : '' }}>&nbsp;Visita concretada</label>
						</div>
						<div class="columna columna-5">
							<label><input type="checkbox" name="by_reference" id="by_reference" value="1" {{ old('by_reference',$visit->by_reference) ? 'checked="checked"' : '' }}>&nbsp;Por referencia</label>
						</div>
						<div class="columna columna-5">
							<label><input type="checkbox" name="has_proposal" id="has_proposal" value="1" {{ old('has_proposal',$visit->prop_code) ? 'checked="checked"' : '' }}>&nbsp;Agregar propuesta</label>
						</div>
						<div class="columna columna-5">
