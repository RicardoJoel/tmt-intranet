...
<div class="fila">
	<div class="columna columna-1">
		<div class="title2">
			<h6>Entidades > Servidores > Editar ></h6>
		</div>
	</div>
</div>
					...
					<div class="fila">
						...
						<div class="columna columna-2">
							...
							<select name="ubigeo_id" id="ubigeo_id" required>
								...
								<option value="{{ $index }}" {{ old('ubigeo_id',$user->ubigeo_id) == $index ? 'selected' : '' }}>
									{{ $ubigeo }}
								</option>
								@endforeach
							</select>
				...
				<div id="div-lab">
					...
					<div class="fila">
						...
						<div class="columna columna-6">
							...
							<input type="text" value="{{ number_format($user->cur_salary,2) }}" disabled>
						</div>
						<div class="columna columna-6">
							<p>Comisión (%)</p>
							<input type="number" name="commission" id="commission" value="{{ old('commission',number_format($user->commission,2)) }}" onkeypress="return checkNumber(event)">
						</div>
						<div class="columna columna-6">
					...
					<div class="fila">
						<div class="columna columna-3">
							...
							<select name="contact_ubigeo_id" id="contact_ubigeo_id">
								<option selected disabled hidden value="">Selecciona un distrito</option>
								@foreach ($ubigeos->get() as $index => $ubigeo)
								<option value="{{ $index }}" {{ old('contact_ubigeo_id',$user->contact_ubigeo_id) == $index ? 'selected' : '' }}>
									{{ $ubigeo }}
								</option>
								@endforeach
							</select>
