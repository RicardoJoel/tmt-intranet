...
<div class="fila">
	...
	<div class="columna columna-1">
		...
		<ul>
			...
			<li>El tamaño máximo del nombre y apellidos del servidor es cincuenta (50) caracteres.</li>
			<li>El tamaño máximo de la dirección de domicilio del servidor es cien (100) caracteres.</li>
