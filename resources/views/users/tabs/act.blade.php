<div id="act" class="tabcontent" style="display:block">
            ...
            <tr>
                ...
                <td><center>
                    <form action="{{ action('UserController@destroy', $user->id) }}" method="post">
                        ...
                        <button class="btn btn-danger btn-xs" type="submit" onclick="return confirm('¿Realmente desea eliminar el servidor seleccionado?')"><span class="glyphicon glyphicon-trash"></span></button>
                    </form>
                </center></td>
            </tr>
            @endif
