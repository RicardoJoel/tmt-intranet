...
<div id="gantEditorTemplates" style="display:none">
    <div class="__template__" type="GANTBUTTONS"><!--
        <div class="ganttButtonBar noprint">
            <div class="buttons">
                ...
                <button onclick="$('#workSpace').trigger('zoomPlus.gantt');return false;" class="button textual icon " title="Acercar gráfico"><span class="teamworkIcon">(</span></button>
                <span class="ganttButtonSeparator"></span>
                ...
                <button onclick="editResources();" class="button textual" title="Recursos involucrados"><span class="teamworkIcon">M</span></button>
                &nbsp; &nbsp; &nbsp; &nbsp;
    ...
    <div class="__template__" type="TASKROW"><!--
        <tr id="tid_(#=obj.id#)" taskId="(#=obj.id#)" class="taskEditRow (#=obj.isParent()?'isParent':''#) (#=obj.collapsed?'collapsed':''#)" level="(#=level#)">
            <th class="gdfCell edit" align="right" style="cursor:pointer;"><span class="taskRowIndex">(#=obj.getRow()+1#)</span> <span class="teamworkIcon" style="font-size:12px;" >8</span></th>
            <td class="gdfCell noClip" align="center"><div class="taskStatus cvcColorSquare" status="(#=obj.status#)"></div></td>
            <td class="gdfCell"><input type="text" name="code" value="(#=obj.code?obj.code:''#)" maxlength="20" disabled></td>
            <td class="gdfCell indentCell" style="padding-left:(#=obj.level*10+18#)px;">
                <div class="exp-controller" align="center"></div>
                <input type="text" name="name" value="(#=obj.name#)" maxlength="200" disabled>
            </td>
            <td class="gdfCell" align="center"><input type="checkbox" name="startIsMilestone" disabled></td>
            <td class="gdfCell"><input type="text" name="start" value="" class="date" disabled></td>
            <td class="gdfCell" align="center"><input type="checkbox" name="endIsMilestone" disabled></td>
            <td class="gdfCell"><input type="text" name="end" value="" class="date" disabled></td>
            <td class="gdfCell"><input type="text" name="duration" autocomplete="off" value="(#=obj.duration#)" disabled></td>
            <td class="gdfCell"><input type="text" name="progress" class="validated" entrytype="PERCENTILE" autocomplete="off" value="(#=obj.progress?obj.progress:''#)" (#=obj.progressByWorklog?"readOnly":""#) disabled></td>
            <td class="gdfCell requireCanSeeDep"><input type="text" name="depends" autocomplete="off" value="(#=obj.depends#)" (#=obj.hasExternalDep?"disabled":""#) maxlength="100" disabled></td>
    ...
    <div class="__template__" type="TASK_EDITOR"><!--
        <div class="ganttTaskEditor">
            <h6 class="taskData title3">Detalle de la tarea</h6>
            ...
            <table cellspacing="1" cellpadding="5" width="99%" class="taskData">
                <tr>
                    <td colspan="2" valign="top">
                        ...
                        <input type="text" name="name" id="name"class="formElements" autocomplete='off' maxlength="200" style='width:95%' value="" required="true" oldvalue="1" disabled>
                    </td>
                    <td style="height:80px" valign="top">
                        <p for="code">Código</p>
                        <input type="text" name="code" id="code" value="" size=15 class="formElements" autocomplete='off' maxlength="20" oldvalue="1" disabled>
                    </td>
                </tr>
                <tr class="dateRow">
                    <td nowrap="">
                        <div style="position:relative">
                            ...
                            <input type="text" name="start" id="start" size="8" class="formElements dateField validated date" autocomplete="off" maxlength="10" value="" oldvalue="1" entrytype="DATE" style="width:140px" disabled>
                            ...
                            <input type="checkbox" id="startIsMilestone" name="startIsMilestone" value="yes" disabled>&nbsp;<label for="startIsMilestone">Es un hito</label>&nbsp;<br>
                        </div>
                    </td>
                    <td nowrap="">
                        <p for="end">Fecha fin</p>
                        <input type="text" name="end" id="end" size="8" class="formElements dateField validated date" autocomplete="off" maxlength="10" value="" oldvalue="1" entrytype="DATE" style="width:140px" disabled>
                        ...
                        <input type="checkbox" id="endIsMilestone" name="endIsMilestone" value="yes" disabled>&nbsp;<label for="endIsMilestone">Es un hito</label>&nbsp;<br>
                    </td>
                    <td nowrap="">
                        <p for="duration" class=" ">Duración (días)</p>
                        <input type="number" name="duration" id="duration" size="4" class="formElements validated durationdays" autocomplete="off" value="" oldvalue="1" entrytype="DURATIONDAYS" disabled>&nbsp;
                    </td>
                </tr>
                <tr>
                    <td>
                        <p for="status" class=" ">Estado</p>
                        <select id="status" name="status" class="taskStatus" status="(#=obj.status#)" onchange="$(this).attr('STATUS',$(this).val());" style="width:140px" disabled>
                    ...
                    <td valign="top" nowrap>
                        <p>Prioridad</p>
                        <input type="number" name="relevance" id="relevance" size="7" class="formElements validateddurationdays" autocomplete="off" value="" oldvalue="1" entrytype="DURATIONDAYS" style="width:140px" disabled>
                    </td>
                    <td valign="top" nowrap>
                        <p>Progreso (%)</p>
                        <input type="number" name="progress" id="progress" size="7" class="formElements validated percentile" autocomplete="off" maxlength="10" value="" oldvalue="1" entrytype="PERCENTILE" disabled>
                    </td>
                </tr>
                <tr>
                    <td colspan="4">
                        <p for="description">Descripción</p>
                        <textarea rows="3" cols="30" id="description" name="description" maxlength="500" class="formElements" style="width:100%" disabled></textarea>
                    </td>
                </tr>
            </table>
            ...
            <div style="padding-top:20px">
                <center>
                <button class="btn-effie" onclick="closeBlackPopup();">Cerrar</button>
                </center>
            </div>
        </div>
    --></div>
    ...
    <div class="__template__" type="ASSIGNMENT_ROW"><!--
        <tr taskId="(#=obj.task.id#)" assId="(#=obj.assig.id#)" class="assigEditRow" >
            <td ><select name="resourceId" class="formElements" (#=obj.assig.id.indexOf("tmp_")==0?"":"disabled"#) disabled></select></td>
            <td ><select type="select" name="roleId" class="formElements" disabled></select></td>
            <td ><input type="text" name="effort" value="(#=getMillisInHoursMinutes(obj.assig.effort)#)" size="5" class="formElements" disabled></td>
        </tr>
    --></div>

    <div class="__template__" type="RESOURCE_EDITOR"><!--
        <div class="resourceEditor" style="padding:5px">
            <h6 class="title3">Recursos involucrados</h6>
