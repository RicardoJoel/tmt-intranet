            ...
            <div class="modal-body">
                ...
                <form method="POST" action="{{ route('activities.store') }}" role="form" id="frm-create">
                    ...
                    <div class="fila">
                        ...
                        <div class="columna columna-4">
                            <input type="color" id="color" name="color" value="{{ old('color','#3788d8') }}" title="Color de fondo">
                        </div>
                        <div class="columna columna-2">
                    ...
                    <div class="modal-footer">
                        <center>
                        <button type="submit" class="btn-effie"><i class="fa fa-save"></i>&nbsp;Registrar</button>
