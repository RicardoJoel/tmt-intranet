...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    protected $fillable = [
        ...
        'address', 'ubigeo_id', 'country_id', 'mobile', 'phone', 'annex', 'alt_email',
        'relationship_id', 'profile_id', 'str_salary', 'cur_salary', 'commission', 'frequency_id', 'start_at', 'end_at',
        'bank_id', 'bank_account', 'cci', 'afp_id', 'commission_id', 'cuspp', 'cts_id', 'cts_account', 'eps_id', 'essalud',
        'contact_fullname', 'contact_relationship', 'contact_address', 'contact_ubigeo_id', 'contact_country_id', 
        'contact_mobile', 'contact_phone', 'contact_annex', 'password', 'department_id'
    ];
