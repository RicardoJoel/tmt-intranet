...
class SupplierController extends Controller
{
    ...
    protected function validationErrorMessages()
    {
        return [
            ...
            'profile_id.int' => 'El ID del servicio ingresado no tiene un formato válido.',
            ...
            'other.max' => 'Para especificar otro servicio debes ingresar como máximo cien (100) caracteres.',
            ...
            'ubigeo_id.required' => 'Debes ingresar obligatoriamente un distrito de facturación.',
