...
class UserController extends Controller
{
    ...
    protected const MSG_NOT_FOUNDX = 'El servidor solicitado no ha sido encontrado.';
    
    protected const MSG_SCS_UPDUSR = 'El servidor con código value fue actualizado de manera exitosa.';
    protected const MSG_ERR_UPDUSR = 'Lo sentimos, ocurrió un problema mientras se intentaba actualizar el servidor.';
    protected const MSG_SCS_DLTUSR = 'El servidor con código value fue eliminado de manera exitosa.';
    protected const MSG_ERR_DLTUSR = 'Lo sentimos, ocurrió un problema mientras se intentaba eliminar el servidor.';
    ...
    public function update(Request $request, $id)
    {
        ...
        self::validate($request, [
            ...
            'document' => 'required|string|regex:/'.$request->doc_pattern.'/',
    ...
    public function destroy($id)
    {
        ...
        if (!$user->delete())
            return Redirect::back()->with('error', self::MSG_ERR_DLTUSR);
        
        return Redirect::route('users.index')->with('success',str_replace('value',$user->code,self::MSG_SCS_DLTUSR));
    }
    ...
    public static function validationErrorMessages()
    {
        ...
        return [
            ...
            'email.max' => 'El correo electrónico institucional debe tener un máximo de cincuenta (50) caracteres.',
            ...
            'gender_id.int' => 'El ID del género ingresado no tiene un formato válido.',
            'gender_id.min' => 'El ID del género ingresado es inválido.',
            ...
            'alt_email.max' => 'El correo electrónico personal debe tener un máximo de cincuenta (50) caracteres.',

            'relationship_id.required' => 'Debes ingresar obligatoriamente un vínculo laboral.',
            'relationship_id.int' => 'El ID del vínculo laboral ingresado no tiene un formato válido.',
            'relationship_id.min' => 'El ID del vínculo laboral ingresado es inválido.',

            'department_id.required' => 'Debes ingresar obligatoriamente un área funcional.',
            'department_id.int' => 'El ID del área funcional ingresada no tiene un formato válido.',
            'department_id.min' => 'El ID del área funcional ingresada es inválido.',

            'profile_id.required' => 'Debes ingresar obligatoriamente un cargo.',
            'profile_id.int' => 'El ID del cargo ingresado no tiene un formato válido.',
            'profile_id.min' => 'El ID del cargo ingresado es inválido.',
            ...
            'frequency_id.required' => 'Debes ingresar obligatoriamente una frecuencia de variación salarial.',
            'frequency_id.int' => 'El ID de la frecuencia de variación salarial no tiene un formato válido.',
            'frequency_id.min' => 'El ID de la frecuencia de variación salarial ingresada es inválido.',
            ...
            'bank_id.int' => 'El ID de la entidad bancaria Sueldo no tiene un formato válido.',
            'bank_id.min' => 'El ID de la entidad bancaria Sueldo ingresada es inválido.',

            'bank_account.required' => 'Debes ingresar obligatoriamente un N° Cuenta Sueldo.',
            'bank_account.max' => 'El N° Cuenta Sueldo debe tener un máximo de veinte (20) caracteres.',

            'cci.required' => 'Debes ingresar obligatoriamente un Código de Cuenta Interbancario.',
            'cci.max' => 'El Código de Cuenta Interbancario debe tener un máximo de veintitrés (23) caracteres.',

            'afp_id.required' => 'Debes ingresar obligatoriamente una Adm. Fondo de pensiones.',
            'afp_id.int' => 'El ID de la Adm. Fondo de pensiones no tiene un formato válido.',
            'afp_id.min' => 'El ID de la Adm. Fondo de pensiones ingresada es inválido.',

            'commission_id.required' => 'Debes ingresar obligatoriamente un tipo de comisión.',
            'commission_id.int' => 'El ID del tipo de comisión no tiene un formato válido.',
            'commission_id.min' => 'El ID del tipo de comisión ingresada es inválido.',

            'cuspp.required' => 'Debes ingresar obligatoriamente un código CUSPP.',
            'cuspp.max' => 'El código CUSPP debe tener un máximo de doce (12) caracteres.',

            'cts_id.required' => 'Debes ingresar obligatoriamente una entidad bancaria CTS.',
            'cts_id.int' => 'El ID de la entidad bancaria CTS no tiene un formato válido.',
            'cts_id.min' => 'El ID de la entidad bancaria CTS ingresada es inválido.',

            'cts_account.required' => 'Debes ingresar obligatoriamente un N° Cuenta CTS.',
            'cts_account.max' => 'El N° Cuenta CTS debe tener un máximo de quince (20) caracteres.',

            'eps_id.required' => 'Debes ingresar obligatoriamente un plan EPS.',
            'eps_id.int' => 'El ID del plan EPS no tiene un formato válido.',
            'eps_id.min' => 'El ID del plan EPS ingresado es inválido.',

            'essalud.required' => 'Debes ingresar obligatoriamente un código Essalud.',
            'essalud.max' => 'El código Essalud debe tener un máximo de quince (15) caracteres.',

            'contact_fullname.regex' => 'El nombre completo del contacto en caso de emergencia debe incluir únicamente letras y espacios en blanco entre palabras.',
            'contact_fullname.max' => 'El nombre completo del contacto en caso de emergencia debe tener un máximo de cincuenta (50) caracteres.',            

            'contact_relationship.regex' => 'El parentesco del contacto en caso de emergencia debe incluir únicamente letras y espacios en blanco entre palabras.',
            'contact_relationship.max' => 'El parentesco del contacto en caso de emergencia debe tener un máximo de cincuenta (50) caracteres.',            

            'contact_address.max' => 'La dirección del contacto en caso de emergencia debe tener un máximo de cien (100) caracteres.',

            'contact_ubigeo_id.int' => 'El ID del distrito del contacto en caso de emergencia ingresado no tiene un formato válido.',
            'contact_ubigeo_id.min' => 'El ID del distrito del contacto en caso de emergencia ingresado es inválido.',

            'contact_country_id.int' => 'El ID del código país del contacto en caso de emergencia ingresado no tiene un formato válido.',
            'contact_country_id.min' => 'El ID del código país del contacto en caso de emergencia ingresado es inválido.',

            'contact_mobile.regex' => 'El número celular del contacto en caso de emergencia debe estar compuesto por nueve (9) dígitos.',            
            'contact_phone.regex' => 'El teléfono fijo del contacto en caso de emergencia debe estar compuesto por el código de ciudad seguido de seis (6) o siete (7) dígitos.',
            'contact_annex.regex' => 'El anexo del contacto en caso de emergencia debe tener entre cuatro (4) y seis (6) dígitos.',
