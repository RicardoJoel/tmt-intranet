...
class InvoicesExport extends DefaultValueBinder implements FromArray, WithHeadings, WithCustomValueBinder, ShouldAutoSize, WithStyles
{
    ...
    public function headings(): array
    {
        return [
            ...
            [],
            [/*'Sponsor:',*/ 'Proyecto / Grupo de actividades:', 'Servidor:', 'Estado:'],
            [/*$this->customer,*/ $this->project, $this->user, $this->status],
            [],
            ['Fecha', 'Servidor', /*'Sponsor',*/ 'Gerencia', 'Proyecto / Grupo de actividades', 'Estado proyecto', 'Actividad', 'Estado actividad', 'Tarea', 'Responsable del proyecto', 'Inicio', 'Término', 'Tiempo', 'Minutos', 'Comentario']
        ];
    }
